 ...
 * @var string
 */
if (!defined('SECRET_ACCESS_TOKEN')) define('SECRET_ACCESS_TOKEN', 'wsjn9756');
 ...
 * @var string
 */
if (!defined('REMOTE_REPOSITORY')) define('REMOTE_REPOSITORY', 'git@github.com:wsjnohyeah/laravel-testing.git');
 ...
 */
if (!defined('TARGET_DIR')) define('TARGET_DIR', '/var/www/html/testing/');
